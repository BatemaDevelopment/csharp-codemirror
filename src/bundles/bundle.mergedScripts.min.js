var full=function(exports){'use strict';/**
...
darkBackground="#21252b",highlightBackground="#2c313a",background="#282c34",tooltipBackground="#353a42",selection="#3E4451",cursor="#528bff";/**
   ...
   */const oneDarkTheme=/*@__PURE__*/EditorView.theme({"&":{color:ivory,backgroundColor:background},".cm-content":{caretColor:cursor},".cm-cursor, .cm-dropCursor":{borderLeftColor:cursor},"&.cm-focused .cm-selectionBackground, .cm-selectionBackground, .cm-content ::selection":{backgroundColor:selection},".cm-panels":{backgroundColor:darkBackground,color:ivory},".cm-panels.cm-panels-top":{borderBottom:"2px solid black"},".cm-panels.cm-panels-bottom":{borderTop:"2px solid black"},".cm-searchMatch":{backgroundColor:"#72a1ff59",outline:"1px solid #457dff"},".cm-searchMatch.cm-searchMatch-selected":{backgroundColor:"#6199ff2f"},".cm-activeLine":{backgroundColor:"#6699ff0b"},".cm-selectionMatch":{backgroundColor:"#aafe661a"},"&.cm-focused .cm-matchingBracket, &.cm-focused .cm-nonmatchingBracket":{backgroundColor:"#bad0f847",outline:"1px solid #515a6b"},".cm-gutters":{backgroundColor:background,color:stone,border:"none"},".cm-activeLineGutter":{backgroundColor:highlightBackground},".cm-foldPlaceholder":{backgroundColor:"transparent",border:"none",color:"#ddd"},".cm-tooltip":{border:"none",backgroundColor:tooltipBackground},".cm-tooltip .cm-tooltip-arrow:before":{borderTopColor:"transparent",borderBottomColor:"transparent"},".cm-tooltip .cm-tooltip-arrow:after":{borderTopColor:tooltipBackground,borderBottomColor:tooltipBackground},".cm-tooltip-autocomplete":{"& > ul > li[aria-selected]":{backgroundColor:highlightBackground,color:ivory}}},{dark:true});const toggleHelp=StateEffect.define();const helpPanelState=StateField.define({create:()=>false,update(value,tr){for(let e of tr.effects){if(e.is(toggleHelp)){value=e.value;return value;}}},provide:f=>showPanel.from(f,on=>on?createHelpPanel:null)});function createHelpPanel(view){const help=`
    F1: Toggle the help panel,
    Tab: Indent Code,
    Escape: Escape from the "keyboard-trap"
  `;let dom=document.createElement('div');dom.textContent=help;dom.className="cm-help-panel";return{top:true,dom};}const helpKeymap=[{key:"F1",run(view){view.dispatch({effects:toggleHelp.of(!view.state.field(helpPanelState))});return true;}}];let output={extension:[EditorView.updateListener.of(()=>{function consoleTextArea(textarea){document.getElementById("output").setAttribute("srcdoc",encodeURIComponent(textarea.value));}consoleTextArea(document.createElement("textarea"));})]};let startState=EditorState.create({doc:"using System;\npublic static class Program\n{\n\tpublic static void Main(string[] args)\n\t{\n\t\tConsole.WriteLine(\"Hello, World!\");\n\t}\n}",extensions:[keymap.of(defaultKeymap),handleTab(),basicSetup,StreamLanguage.define(csharp),output,helpPanel(),oneDarkTheme]});window.view=new EditorView({state:startState,parent:document.querySelector("#editor")});function handleTab(){return keymap.of([indentWithTab]);}function helpPanel(){return[helpPanelState,keymap.of(helpKeymap)];}exports.handleTab=handleTab;exports.helpPanel=helpPanel;Object.defineProperty(exports,'__esModule',{value:true});return exports;}({});
